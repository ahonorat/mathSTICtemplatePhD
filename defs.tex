...
\section*{\selectfontbackcover\small\textcolor{mathSTIC-Color}{Titre : }{\selectfontbackcover\mdseries{\getTitleFR{}}}} % In this particular case, font style needs to get re-selected locally
\vspace{-0.2cm}
...
\section*{\selectfontbackcover\small\textcolor{mathSTIC-Color}{Title: }{\selectfontbackcover\mdseries{\getTitleEN{}}}} % In this particular case, font style needs to get re-selected locally
\vspace{-0.2cm}
\noindent{ \small \textbf{Keywords: }#1}\par
\vspace{-0.2cm}
\begin{multicols}{2}
\begin{small}
\begin{spacing}{1}
	\noindent \textbf{Abstract: }#2
\end{spacing}
\end{small}
\end{multicols}
}
